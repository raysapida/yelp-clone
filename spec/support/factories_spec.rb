    ...
    describe "#{factory_name} factory" do
      ...
      it "is valid" do
        ...
        if factory.respond_to?(:valid?)
          # the lamba syntax only works with
          # rspec 2.14 or newer;  for earlier versions, you
          # have to call #valid? before calling the
          # matcher, otherwise the errors will be empty
